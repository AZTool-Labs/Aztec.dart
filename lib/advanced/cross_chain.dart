...
class CrossChainManager {
  ...
  Future<void> initialize() async {
    try {
      ...
      _bridgeContracts[1] = '0x1234567890123456789012345678901234567890'; // Ethereum Mainnet
      _bridgeContracts[42161] = '0x0987654321098765432109876543210987654321'; // Arbitrum
  ...
  Future<AztecTransactionReceipt> bridgeToL1(
    ...
    try {
      ...
      _logger.debug('Bridging transaction submitted: ${transaction.id}, status: ${receipt.status}');
  ...
  void registerBridgeContract(int chainId, String contractAddress) {
    ...
    _logger.debug('Registered bridge contract for chain $chainId: $contractAddress');
  }
...
```dart file="lib/src/plugins/plugin_manager.dart"
import 'dart:async';
...
class PluginManager {
  ...
  Future<List<dynamic>> executeHook(String hook, Map<String, dynamic> args) async {
    try {
