...
class NoirEngine {
  ...
  bool _initializeRuntime(NoirEngineConfig config) {
    ...
    final initFunctionPtr = _noirLib.lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>('noir_initialize');
    
    // Create the Dart function from the native function
    final initFunction = initFunctionPtr.asFunction<bool Function(ffi.Pointer<ffi.Void>)>();
  ...
  Future<CompiledCircuit> compileCircuit(
    ...
    try {
      ...
      final compileFunctionPtr = _noirLib.lookup<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(
        ffi.Pointer<ffi.Utf8>,
        ffi.Pointer<ffi.Void>
      )>>('noir_compile_circuit');
      
      // Create the Dart function from the native function
      final compileFunction = compileFunctionPtr.asFunction<ffi.Pointer<ffi.Void> Function(
        ffi.Pointer<ffi.Utf8>,
        ffi.Pointer<ffi.Void>
      )>();
      
      // Convert options to native structure
      final optionsPtr = options != null ? _optionsToNative(options) : ffi.nullptr;
  ...
  Future<CompiledCircuit> loadCompiledCircuit(
    ...
    try {
      ...
      final loadFunctionPtr = _noirLib.lookup<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(
        ffi.Pointer<ffi.Uint8>,
        ffi.Uint32
      )>>('noir_load_circuit');
      
      // Create the Dart function from the native function
      final loadFunction = loadFunctionPtr.asFunction<ffi.Pointer<ffi.Void> Function(
        ffi.Pointer<ffi.Uint8>,
        int
      )>();
  ...
  Future<void> dispose() async {
    ...
    try {
      ...
      final cleanupFunctionPtr = _noirLib.lookup<ffi.NativeFunction<ffi.Void Function()>>('noir_cleanup');
