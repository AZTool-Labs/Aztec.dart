...
///
/// It provides methods for interacting with the Aztec Network API,
/// including account management, asset operations, and transaction handling.
class AztecNetworkClient {
  ...
  /// Logger instance for the AztecNetworkClient
  final Logger _logger = Logger('AztecNetworkClient');

  /// Constructor for AztecNetworkClient
  AztecNetworkClient({
...
/// Factory for creating Aztec Network client instances
class AztecNetworkClientFactory {
  /// Create a mainnet network client instance
  static Future<AztecNetworkClient> createMainnet() async {
    final client = AztecNetworkClient(
  ...
  /// Create a testnet network client instance
  static Future<AztecNetworkClient> createTestnet() async {
    final client = AztecNetworkClient(
  ...
  /// Create a local network client instance
  static Future<AztecNetworkClient> createLocal(
  ...
  /// Create a custom network client instance
  static Future<AztecNetworkClient> createCustom({
