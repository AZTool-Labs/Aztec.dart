...
class AztecAccount {
  ...
  /// The network client this account is associated with
  final AztecNetworkClient _client;
  ...
  AztecAccount({
    ...
    required AztecNetworkClient client,
  ...
  /// [client] - The network client to create the account on
  ...
  Future<void> _initialize() async {
    try {
      ...
      await _client.registerAccount(this);
  ...
  Future<BigInt> getBalance(String assetId) async {
    try {
      return await _client.getBalance(id, assetId);
    } catch (e, stackTrace) {
  ...
  Future<Map<String, BigInt>> getAllBalances() async {
    try {
      return await _client.getAllBalances(id);
    } catch (e, stackTrace) {
      _logger.error(
